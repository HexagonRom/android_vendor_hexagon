...
custom_dependencies = "hexagon.dependencies"
org_manifest = "hexagon-devices"  # leave empty if org is provided in manifest
org_display = "HexagonRom-Devices"  # needed for displaying
